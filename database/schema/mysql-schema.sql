...
CREATE TABLE `eb_admin` (
  ...
  `language` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en' COMMENT '语言',
...
CREATE TABLE `eb_user` (
  ...
  `standby_contacts_phone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '备用联系人手机号',
