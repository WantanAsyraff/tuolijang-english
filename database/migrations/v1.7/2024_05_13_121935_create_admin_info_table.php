...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('admin_info', function (Blueprint $table) {
            ...
            $table->string('work_time', 32)->nullable()->default('')->comment('入职时间');
            $table->string('trial_time', 32)->nullable()->default('')->comment('试用时间');
            $table->string('formal_time', 32)->nullable()->default('')->comment('转正时间');
            $table->string('treaty_time', 32)->nullable()->default('')->comment('合同到期时间');
