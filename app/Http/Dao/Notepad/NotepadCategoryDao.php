...
namespace App\Http\Dao\Notepad;

use App\Http\Dao\User\UserMemorialCategoryDao;
use App\Http\Model\Notepad\NotepadCategory;
 ...
 * 笔记目录.
 */
class NotepadCategoryDao extends BaseDao
{
    use ListSearchTrait;
    ...
    /**
     * 是否携带子文件夹数量.
     * @return UserMemorialCategoryDao
     */
    public function setWithListCount(bool $withListCount): NotepadCategoryDao
    {
