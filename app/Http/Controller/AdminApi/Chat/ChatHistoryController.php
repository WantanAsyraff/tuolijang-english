...
class ChatHistoryController extends AuthController
{
    ...
    public function save(ApiRequest $request)
    {
        ...
        $appInfo = app()->get(ChatApplicationsService::class)->get($data['chat_application_id']);
        if (! $appInfo) {
     ...
     * @return mixed
     */
    #[Post('crud_dialog', 'ai 对话生成字段')]
    public function crudDialog()
    {
        ...
        return $this->success($this->service->crudDialog($message, (int) $crudId, (array) $fields));
    }
}
