...
class OrderListTool extends BaseTool
{
    ...
    public function getInputSchema(): array
    {
        ...
        $properties = [
            'limit' => ['type' => 'integer', 'description' => '返回订单数量限制，默认20', 'default' => 20],
    ...
    {
        return $this->getSearchFieldsByCustomType(ViewSearchEnum::VIEW_CONTRACT);
    }
    ...
    public function execute(array $arguments): array
    {
        ...
        $where = [
            'types'       => ViewSearchEnum::VIEW_CONTRACT,
