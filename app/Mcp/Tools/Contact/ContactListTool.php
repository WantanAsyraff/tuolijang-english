...
class ContactListTool extends BaseTool
{
    use ResolvesPersonnelArguments;

    public function getDescription(): string
    {
        return '获取联系人列表，支持通过动态搜索条件筛选';
    }
    ...
    public function getInputSchema(): array
    {
        ...
        $properties = [
            'limit' => ['type' => 'integer', 'description' => '返回联系人数量限制，默认20', 'default' => 20],
    ...
    {
        return $this->getSearchFieldsByCustomType(ViewSearchEnum::VIEW_LIAISON);
    }

    public function execute(array $arguments): array
    {
        $service = app(LiaisonService::class);
        ...
        $where = [
            'types'       => ViewSearchEnum::VIEW_LIAISON,
