<template>
  <view class="content">
    ...
    <view class="assessment m10">
          ...
          <template v-slot:body>
            <view class="item-list">
              <uni-row class="item-list-top display-align">
                ...
                <uni-col :span="18" class="item-list-top-right">{{ $t('ui.userUserRecordXiaobei') }}</uni-col>
              </uni-row>
              <uni-row class="item-list-content">
                <uni-col :span="6" class="left">{{ $t('ui.forgotPasswordIndexMobileNumber') }}</uni-col>
                <uni-col :span="18">{{item.phone}}</uni-col>
              </uni-row>
              <uni-row class="item-list-content">
                <uni-col :span="6" class="left">{{ $t('ui.userUserRecordUserStatus') }}</uni-col>
                <uni-col :span="18">{{ $t('ui.userUserRecordApproved') }}</uni-col>
              </uni-row>
              <uni-row class="item-list-content">
                <uni-col :span="6" class="left">{{ $t('ui.userUserRecordRegistrationTime') }}</uni-col>
                <uni-col :span="18">
              ...
              <uni-row class="item-list-content">
                <uni-col :span="12" style="padding-right: 16rpx;">
                  <button class="default-color">{{ $t('ui.customerQuickReplyIndexEdit') }}</button>
                </uni-col>
                <uni-col :span="12" style="padding-left: 16rpx;">
                  <button class="default-error">{{ $t('ui.examineFormApprovalBillDelete') }}</button>
                </uni-col>
              </uni-row>
      ...
      <empty v-else :index="2" :title="$t('ui.userUserRecordNoInvitationRecords')"></empty>
    </view>
  </view>
</template>
