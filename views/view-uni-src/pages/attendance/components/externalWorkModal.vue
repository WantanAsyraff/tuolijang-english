  ...
  <view class="modal">
    <view class="head">
      ...
      <view class="time">
        ...
        {{ $t('ui.attendanceExternalWorkModalClockInTime') }} {{ timeString }}
      </view>
      <view class="address">
    ...
    <view class="content">
      <uni-easyinput
        ...
        :input-border="false"
        :placeholder="$t('ui.attendanceExternalWorkModalEnterContent')"
        :maxlength="140"
        :rows="10"
      />
      <view class="upload">
    ...
    <view class="bottom">
      <view class="cancel btn" @click="emit('cancel')">{{ $t('ui.baTreePickerIndexCancel') }}</view>
      <view class="line"></view>
      <view class="ok btn" @click="handleOk">{{ $t('ui.baTreePickerIndexOk') }}</view>
    </view>
  </view>
</template>
