          ...
          <uni-forms-item class="is-direction-top p24">
            <template v-slot:label>
              <view class="uni-forms-item__label mt36">
                {{ $t('ui.customerContractAddFileRecordDescription') }} <text class="iconfont">*</text>
              </view>
            </template>
            <uni-easyinput :inputBorder="false" class="max-height" v-model="formData.content" type="textarea" :clearable="false" :styles="styles"
              :placeholder-style="placeholderStyle" :maxlength="256" :autoHeight="true" :placeholder="$t('ui.customerContractAddFilePleaseEnterRecordDescription')">
            </uni-easyinput>
          </uni-forms-item>
        </view>
          ...
          <uni-forms-item class="is-direction-top">
            <template v-slot:label>
              <view class="uni-forms-item-con mt36 ">
                <uni-row class="">
                  <uni-col :span="22">
                    <view class="">{{ $t('ui.customerContractAddFileAddFile') }}</view>
