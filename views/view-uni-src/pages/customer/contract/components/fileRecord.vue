            ...
            <view class="content">
              <view class="header">
                ...
                <dean-popover ref="deanPopoverRef" model-direction="right">
                  ...
                  <view class="modal-item" @click="addRecord(1,item,index)"><text class="iconfont icon-gongzuohuibao-bianji"></text>{{ $t('ui.customerQuickReplyIndexEdit') }}</view>
                  <view class="modal-item" @click="addRecord(2,item,index)"><text class="iconfont icon-shanchu1"></text>{{ $t('ui.examineFormApprovalBillDelete') }}
                  </view>
                </dean-popover>
              </view>
              <view class="mark">
