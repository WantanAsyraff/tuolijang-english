<template>
  ...
  <view>
    <!-- 输入框搜索 -->
    <uni-search-bar :placeholder="$t('ui.customerSigningFormBoxSearchContract')"  bgColor="#F5F5F5" v-model="data.where.name" @clear="searchFn" @blur="searchFn" @change="searchFn">
