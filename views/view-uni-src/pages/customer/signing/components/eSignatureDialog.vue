<template>
  <view>
    ...
    >
      <view class="content">
        <view class="title">{{ $t('ui.customerSigningESignatureDialogSignerSigning') }}</view>
      <view class="iconfont icon-shenpizhongxin-jujue" @click="handlePopupClose" />
        <view class="qrcode-box">
          <view v-if="isLoading" class="loading-tip">{{ $t('ui.customerSigningESignatureDialogGeneratingQrCode') }}</view>
          <canvas 
            ref="qrcodeCanvas" 
            id="qrcodeId" 
            class="qrcode-canvas"
        ...
        <view class="tips-text">{{ $t('ui.customerSigningESignatureDialogPressAndHoldToSaveTheQrCodeThen') }}</view>
      </view>
    </uni-popup>
  </view>
</template>
