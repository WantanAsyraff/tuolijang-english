<template>
  <BaseContainer class="base-container">
    ...
    <view class="remark-card">
      <view class="remark-title"> {{ $t('ui.customerContractPayDetailRemarks') }} </view>
      <textarea :placeholder="$t('ui.customerOpportunityEditPriceEnterRemarks')" v-model="remark" class="remark-textarea" />
    </view>
    <BaseBottomBtn :text="$t('ui.replyComponentIndexSubmit')" @click="handleSubmit" />
  </BaseContainer>
</template>
