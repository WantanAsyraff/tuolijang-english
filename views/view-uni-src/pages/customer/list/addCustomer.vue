<template>
  <BaseContainer class="base-container">
    ...
    <!-- 组件 -->
    <success-popup ref="successPopupRef" :type="0" :title="$t('ui.customerListAddCustomerCustomer')" :button-title="$t('ui.customerListAddCustomerAddOpportunity')" @change="successChange"></success-popup>
  </BaseContainer>
</template>
