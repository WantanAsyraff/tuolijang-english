      ...
      <!-- #endif -->
        ...
        <scroll-view :scroll-into-view="scrollViewId" class="uni-indexed-list__scroll" scroll-y>
          ...
          <!-- #endif -->
            ...
            <indexed-list-item :list="list" :loaded="loaded" :idx="idx" :mode="mode" :isChecked="isChecked"
              :showSelect="showSelect"></indexed-list-item>
          <!-- #ifndef APP-NVUE -->
          </view>
        </scroll-view>
        <!-- #endif -->
...
<script>
  ...
  function touchMove(e) {
    ...
    let index = this.getIndexByPageY(pageY);
  ...
  export default {
    ...
    methods: {
      setList() {
        ...
        uni.createSelectorQuery()
          ...
          .exec((ret) => {
            ...
            this.itemHeight = this.lists.length ? this.winHeight / this.lists.length : 0;
          });
        // #endif
        // #ifdef APP-NVUE
      ...
      getIndexByPageY(pageY) {
        if (!this.itemHeight || this.lists.length === 0) {
          return -1;
        }
      ...
      scrollToIndex(index) {
        ...
        const scrollViewId = "uni-indexed-list-" + index;
