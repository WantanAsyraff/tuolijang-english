      ...
      <view class="target">
        ...
        <view class="plr10">
          <view class="display-align" @click="clickOrganizationRef">
            ...
            <view class="title p-l-30 default-text-color-one">{{ $t('ui.usersDepartmentIndexOrganization') }}</view>
          </view>
        </view>
        <view class="personnel m-t-30">{{ $t('ui.usersDepartmentIndexEnterpriseMembers') }}{{data.count}}{{ $t('ui.usersDepartmentIndexPeople') }}</view>
      </view>
