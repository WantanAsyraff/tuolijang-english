        ...
        <view class="pt44">
          <view class="slider-header">
            <uni-row class="display-align plr10">
              <uni-col :span="20" class="header-left">{{ $t('ui.navigationBarSiderbarSelectArticleTagsToFollow') }}</uni-col>
                ...
                <view class="slider-laber" v-for="(item,index) in data.listData" :key="'list'+index">
                  ...
                  <view class="slider-laber-item">
                    <button class="laber-item-button" @click="selectAllLabel(item)"
                      ...
                      <text class="title line1">{{item.selectAll ? $t('ui.navigationBarSiderbarDeselectAll') : $t('ui.navigationBarSiderbarAll')}}</text>
                    </button>
          ...
          <view class="slider-bottom plr10">
            <button :loading="loading" @click="saveLabel">{{ $t('ui.moduleFormCascadeOk') }}</button>
          </view>
        </view>
      </view>
    </uni-popup>
