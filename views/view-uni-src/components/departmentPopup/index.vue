    ...
    <uni-popup ref="popupRef" type="bottom">
      <view class="slider">
        <view v-if="!data.managementScope"  class="tab">
          <view class="tab-title" @click="tabFn(1)" :class="data.tabIndex == 1 ? 'active' : ''"> {{ $t('ui.departmentPopupIndexEmployeesAndDepartments') }} </view>
          <view class="tab-title" @click="tabFn(2)" :class="data.tabIndex == 2 ? 'active' : ''"> {{ $t('ui.timePopupIndexTimeFilter') }} </view>
        </view>
        <!--  tab切换内容 -->
        ...
        <view class="content p30">
          ...
          <view class="btn-flex" v-if="data.tabIndex == 2">
            ...
            <view class="flex" style="width: 100%;" v-if="data.timeIndex == 9">
              <uni-datetime-picker  class="btnshou"  style="width: 45%;" type="date" :placeholder="$t('ui.timePopupIndexStartTime')" :clear-icon="false" v-model="data.start" />
              <text class="text">-</text>
              <uni-datetime-picker  class="btnshou"  style="width: 45%;" type="date" :placeholder="$t('ui.timePopupIndexEndTime')" :clear-icon="false" v-model="data.end"
                @maskClick="maskClick" />
            </view>
          </view>
        </view>
