...
/**
 * @description 批量修改推送消息渠道
 * @param {Object} data
 * @returns {*}
 */
export function batchUpdateMessageApi(data) {
  return request.put(`system/message/batch_update`, data)
}
 ...
 */
export function getWorkConfigApi() {
  return request.get(`work/config`)
}
/**
 * @description 获取企业微信
 */
export function getWorkCorpConfigApi() {
  return request.get(`work/corp/config`)
}

/**
 * @description 获取企业微信配置
 */
export function saveWorkConfigApi(data) {
  return request.post(`work/config/save`,data)
}

/**
 * @description 获取企业微信公钥
 */
export function getWorkRsaApi() {
  return request.get(`work/config/rsa`)
}
