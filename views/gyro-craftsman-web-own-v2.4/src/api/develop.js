 ...
 * @returns {*}
 */
export function getcrudCateListApi(data) {
  return request.get('crud/cate/list',data)
}
 ...
 * @returns {*}
 */
export function saveCrudApi(id,data) {
  return request.post(`crud/cate/one_save/${id}`, data)
}
/**
 *获取应用详情
 * @returns {*}
 */
export function getCrudInfoApi(id) {
  return request.get(`crud/cate/find/${id}`)
}
 ...
 * @returns {*}
 */
export function chatHistoryApi(data) {
  return request.post(`chat/history/crud_dialog`,data)
}
 ...
 * @returns {*}
 */
export function batchFieldSaveApi(data) {
  return request.post(`crud/batch/field/save`,data)
}
 ...
 * @returns {*}
 */
export function dataEventLogApi(data) {
  return request.get(`crud/event/log`,data)
}
 ...
 * @returns {*}
 */
export function getFormPageApi(id) {
  return request.get(`crud/form/page/${id}`)
}
 ...
 * @returns {*}
 */
export function getFormInfoApi(id) {
 ...
 * @returns {*}
 */
export function getFormSaveApi(id,data) {
 ...
 * @returns {*}
 */
export function getFormUpdateApi(id,data) {
  return request.put(`crud/form/update/${id}`,data)
}
 ...
 * @returns {*}
 */
export function delFormApi(id) {
  return request.delete(`crud/form/delete/${id}`)
}
 ...
 * @returns {*}
 */
export function getImportTempApi() {
  return request.get(`crud/import/temp`)
}
 ...
 * @returns {*}
 */
export function delCrudSaveApi(data) {
  return request.post(`config/dict_data/crud_save`,data)
}
 ...
 * @returns {*}
 */
export function delCrudSortPutApi(data) {
  return request.put(`config/dict_data/crud_sort_put`,data)
}
 ...
 * @returns {*}
 */
export function crudDictListApi(id) {
  return request.get(`crud/crud_dict/list/${id}`)
}
 ...
 * @returns {*}
 */
export function crudDictBatchApi(data) {
  return request.post(`crud/crud_dict/batch`,data)
}
