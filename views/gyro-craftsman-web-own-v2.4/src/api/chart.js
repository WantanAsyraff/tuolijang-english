...
// 图表数据获取接口
export async function queryChartData(formModel, type,chartData) {
  const allEntityName = getStorageJson('allEntityName', {})
  ...
  let param = {
    ...
    chart_id: formModel.chartId, // 图表id
