...
/**
 * @description 业绩统计-产品分类业绩统计（圆环）
 * @param data
 */
export function productRankApi(data) {
  return request.post(`client/customer/product_rank`, data)
}
/**
 * @description 业绩统计-产品业绩排行列表
 * @param data
 */
 ...
 * @return {*}
 */
export function chargeCreateApi(data) {
  return request.get(`client/customer/create`,data)
}
 ...
 * @return {*}
 */
export function liaisonCreateApi(data) {
  return request.get(`client/liaisons/create`,data)
}
 ...
 * @return {*}
 */
export function clientConfigLabelDeleteApi(id,data) {
  return request.delete(`client/labels/${id}`,data)
}
 ...
 * @return {*}
 */
export function contractCreateApi(data) {
  return request.get(`client/contracts/create`,data)
}
/**
 * 订单管理--V1.4获取编辑订单表单
 * @return {*}
 */
export function contractEditCreateApi(id,data) {
  return request.get(`client/contracts/${id}/edit`,data)
}
 ...
 * @return {*}
 */
export function invoiceBillApi(id,data) {
  return request.put(`client/invoice/bill/${id}`,data)
}
/**
 * 收支记账操作记录---列表
 * @return {*}
...
export function changeCard(params) {
  return request.get(`company/card/change`, params)
}
 ...
 * @return {*}
 */
export function frameDataListApi(data) {
  return request.post(`client/customer/frame_ranking`, data)
}
 ...
 * @param data
 */
export function cluesViewApi(data) {
 ...
 * @return {*}
 */
export function cluesReturnApi(data) {
 ...
 * @return {*}
 */
export function cluesShiftApi(data) {
 ...
 * @return {*}
 */
export function cluesInfoApi(id) {
  return request.get(`client/clues/info/${id}`)
}
 ...
 * @return {*}
 */
export function cluesClaimApi(data) {
 ...
 * @returns
 */
export function attendanceWorkClockRecord(data) {
  return request.get(`attendance/work_clock_record`, data)
}
