...
<template>
  <div>
    ...
    <!-- 低代码相关弹窗 -->
    <check-drawer v-if="checkDrawerShow" ref="checkDrawer" :keyName="keyName" :info="info" />
  </div>
</template>
...
import { clientBillDetailApi, clientContractDetailApi, clientInvoiceDetailApi } from '@/api/client'
