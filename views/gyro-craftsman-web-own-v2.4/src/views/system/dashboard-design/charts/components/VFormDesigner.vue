    ...
    <el-container class="main full-height">
      <el-container>
        ...
        <el-container class="center-layout-container">
          <el-main class="form-widget-main" @click.native.capture="handleCenterBlankClick">
...
export default {
  ...
  methods: {
    handleCenterBlankClick(event) {
      const target = event.target
      const clickedInsideWidget =
        !!target && typeof target.closest === 'function' && !!target.closest('.smartwidget, .vue-resizable-handle')
