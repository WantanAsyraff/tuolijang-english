...
export const ext_chart_containers = [
  ...
  // 筛选组件
  {
    ...
    options: {
      name: '',
      value: 13232.12,
      label: $('legacyScript.filterComponent'),
      // 数据实体
      entityIds: [], // 选中实体ID
...
export const ext_charts_widgets = [
  // 统计数值
  {
    ...
    options: {
      name: '',
      value: 13232.12,
      label: $('legacyScript.statisticalValue'),
  ...
  // 漏斗图
  {
    ...
    options: {
      name: '',
      value: 13232.12,
      label: $('legacyScript.funnelChart'),
      // 数据实体
      dataEntity: '',
      // 维度指标设置
      setDimensional: {
