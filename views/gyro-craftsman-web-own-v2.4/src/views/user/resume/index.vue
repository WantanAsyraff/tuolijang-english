    ...
    putPerfectAgree(data) {
      ...
      const saveResumeAndConfirm = async () => {
        try {
          ...
          if (error.message.includes('您取消了操作')) {
            return
          }
        }
      }
...
::v-deep .assess-left .head-portrait .avatar {
...
::v-deep .head-portrait .avatar-uploader-icon {
