        ...
        <div class="main">
          ...
          <div v-if="!recently">
            <ul v-if="listData.length > 0" class="content-ul px-14">
              ...
              >
                <div class="title">
                  <!-- <i class="iconfont iconjishiben-01"></i>  -->
...
import none007Img from '@/assets/images/none-007.png'
...
export default {
  ...
  methods: {
    ...
    changeSearch() {
      this.recently ? this.getRecentlyList() : this.getList()
    },
    addMemorandum() {
      var data = {
    ...
    edit(val) {
      if (this.title == '') {
        ...
        if (this.itemIndex) {
          ...
          // 编辑
          if (this.id && (this.listData || this.recentlyData)) {
