  ...
  <el-card class="content employees-card">
    ...
    <div class="mt10">
      ...
      >
        ...
        <el-table-column prop="title" :label="$('ui.settingEnterpriseNewsIndexMessageTitle')" min-width="80">
        ...
        <el-table-column prop="message" :label="$('ui.settingEnterpriseNewsIndexMessageContent')" min-width="360">
          <template slot-scope="scope">
            <div class="notice">{{ notificationText(scope.row, 'message') }}</div>
          </template>
        </el-table-column>
        ...
        <el-table-column :label="$('toptable.operation')" width="100" fixed="right">
          <template slot-scope="scope">
            ...
            >
              <span v-if="scope.row.cate_name !== '考勤'"> {{ notificationButtonText(scope.row, item) }}</span></el-button
            >
          </template>
        </el-table-column>
      </el-table>
      ...
      <div class="isSelect">
        <div class="flex" style="display: inline-block">
          <el-button @click="handleIsRead" size="small" :disabled="multipleSelection.length == 0"
            >{{ $("ui.userNewsIndexMarkAsRead") }}</el-button
          >
