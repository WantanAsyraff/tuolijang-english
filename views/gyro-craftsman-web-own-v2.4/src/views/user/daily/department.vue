...
<!-- 部门汇报页面 -->
<div class="divBox">
  <el-card body-style="padding: 20px 20px 0 20px;" class="employees-card-bottom">
  ...
  methods: {
    confirmData(data) {
      ...
      if (data == 'reset') {
        ...
        if (data.scope_frame) {
          this.tableFrom.scope_frame = data.scope_frame
        }
      }
    ...
    async submitStatisticsApi() {
      ...
      console.log(88888, this.calendar, this.calendarTime, 8888)
    },
