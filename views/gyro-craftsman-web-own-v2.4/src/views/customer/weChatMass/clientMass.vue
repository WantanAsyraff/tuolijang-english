...
<div>
  <div class="divBox" v-if="!isShow">
    <el-card :body-style="{ padding: '20px 20px 20px 20px' }" class="normal-page">
      <oaFromBox
        :search="search"
        :title="$t('ui.customerWeChatMassClientMassCustomerMassSendList')"
        :total="total"
        :treeData="treeData"
        :isViewSearch="false"
        ref="fromBox"
      ...
      <div class="mt10">
        ...
        >
          ...
          <el-table-column :label="$t('ui.customerWeChatMassClientMassSentCustomers')" prop="is_send"> </el-table-column>

          <el-table-column :label="$t('ui.customerWeChatMassClientMassDeliveredCustomers')" prop="is_sent"> </el-table-column>
          <el-table-column :label="$t('ui.customerWeChatMassClientMassUnsentCustomers')" prop="not_sent"> </el-table-column>
