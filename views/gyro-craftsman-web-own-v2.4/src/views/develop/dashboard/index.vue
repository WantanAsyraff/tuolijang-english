<template>
  <div class="dashboard-container box-height">
...
::v-deep .smartwidget.is-always-shadow {
  box-shadow: none;
}
::v-deep .smartwidget.is-hover-shadow:hover {
  box-shadow: none;
}
::v-deep .smartwidget.is-never-shadow {
  box-shadow: none;
}
// ::v-deep .vue-grid-layout > .vue-grid-item:last-child {
//   background: linear-gradient(154deg, #edf6ff 0%, #ffffff 50%, #ffffff 100%);
