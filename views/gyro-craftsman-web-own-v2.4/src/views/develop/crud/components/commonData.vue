...
import dingdingImg from '@/assets/images/empty/dingding.png';
import qitaImg from '@/assets/images/empty/qita.png';
...
export default { messagePushData, weekOptions, timeOptions, activities }
</script>
