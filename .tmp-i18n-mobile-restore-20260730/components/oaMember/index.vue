      ...
      <view class="bag">
        <view class="header bgf">
          <view class="header-title">
            ...
            <text style="text-align: center">选择成员</text>
          </view>
        </view>
        <!-- 搜索 -->
        <view class="search-box bgf">
          <uni-search-bar placeholder="搜索成员" cancelButton="none" bgColor="#F5F5F5" v-model="searchName" @clear="clearData" @input="searchData">
        ...
        <template v-else>
          ...
          <view v-if="!data.isOrgShow" class="org-tips"> 企业成员({{ data.count }}) </view>
          ...
          <view class="personnel-box" v-if="!data.isOrgShow">
            <view class="personnel-count" v-if="searchName" :key="searchName">
              <text>搜索到 {{ filteredList.length }} 人</text>
            </view>
        ...
        <view class="bottom-bar bgf">
          <view class="selected-info" @click="openSelectedPopup">
            <text class="selected-text">已选{{ selectedCount }}人</text>
        ...
        <view class="selected-popup bgf">
          <view class="selected-header bgf">
            <view>
              ...
              <view class="selected-text">已选（{{ selectedCount }} / {{ data.count }}）</view>
            </view>
