            ...
            <view class="item-list" @click="examineList(item)">
              <view class="p24">
                ...
                <uni-row class="item-list-content">
                  <uni-col :span="6" class="left">企微客户</uni-col>
                ...
                <uni-row class="item-list-content">
                  <uni-col :span="6" class="left">客户名称</uni-col>
                  <uni-col :span="18">{{ item.eid || '--' }}</uni-col>
                </uni-row>
                <uni-row class="item-list-content">
                  <uni-col :span="6" class="left">销售金额</uni-col>
                  <uni-col :span="18"> {{ item.total_amount }}元 </uni-col>
                </uni-row>
                <uni-row class="item-list-content">
                  <uni-col :span="6" class="left">业务员</uni-col>
                  <uni-col :span="18" class="time-box">
                    <text> {{ item.salesman.name || '--' }}</text>
                  </uni-col>
                </uni-row>
                <uni-row class="item-list-content">
                  <uni-col :span="6" class="left">跟进时间</uni-col>
                  <uni-col :span="18">
                    <text> {{ item.last_follow_time || '--' }}</text>
                    <text v-if="item.work_customer" class="qiweiBox" @click.stop="openCustomerChat(item.work_customer)"> 发起聊天 </text>
                  </uni-col>
                </uni-row>
              </view>
            </view>
