<template>
  <BaseContainer class="base-container">
    ...
    <view class="cr-position-header">
      ...
      <!-- tab切换 -->
      <view class="tab-box">
        <view class="tab-item" :class="{ active: currentTab === '1' }" @click="currentTab = '1'">产品清单</view>
        <view class="tab-item" :class="{ active: currentTab === '2' }" @click="currentTab = '2'">签约信息</view>
      </view>
    </view>

    <view class="search">
      <view class="required-box"><text>客户名称</text><text class="required">*</text></view>
      <picker
    ...
    <view class="form-card" id="sign-form">
      <uni-forms :border="false" :modelValue="formData" ref="form" label-width="80px" :rules="data.rules">
        ...
        <view class="form-item">
          ...
          <uni-forms-item class="label-box">
            <template v-slot:label>
              <view class="label">合同名称<text class="iconfont">*</text> </view>
            </template>
            <uni-easyinput
              :inputBorder="false"
          ...
          <uni-forms-item class="label-box">
            <template v-slot:label>
              <view class="label">签约方式<text class="iconfont">*</text> </view>
            </template>
            <uni-data-checkbox v-model="formData.sign_type" @change="getProcessInfo" :localdata="data.typesOptions" />
          </uni-forms-item>
          <uni-forms-item class="label-box">
            <template v-slot:label>
              <view class="label">合同期限<text class="iconfont">*</text> </view>
            </template>
          ...
          <uni-forms-item class="label-box" v-if="formData.term_type == 2">
            <template v-slot:label>
              <view class="label">合同时长（天）<text class="iconfont">*</text> </view>
            </template>
            <uni-easyinput
              :inputBorder="false"
          ...
          <template v-if="formData.term_type == 1">
            <uni-forms-item class="label-box">
              <template v-slot:label>
                <view class="label">开始日期<text class="iconfont">*</text> </view>
              </template>
              <uni-datetime-picker
            ...
            <uni-forms-item class="label-box">
              <template v-slot:label>
                <view class="label">结束日期<text class="iconfont">*</text> </view>
              </template>
              <uni-datetime-picker
          ...
          <uni-forms-item class="is-direction-top">
            <template v-slot:label>
              ...
              <view class="tips">(支持pdf、png、jpg、word、excel、txt等格式)</view>
            </template>
        ...
        <view class="form-item">
          ...
          <uni-forms-item class="label-box">
            <template v-slot:label>
              <view class="label">手机号<text class="iconfont">*</text> </view>
            </template>
            <uni-easyinput
              :inputBorder="false"
    ...
    <view>
      <BaseBottomBtn text="提交" :disabled="data.disabled" @click="clickSubmit" />
    </view>
  </BaseContainer>
</template>
<script setup>
