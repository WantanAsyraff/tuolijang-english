  ...
  <BaseContainer class="base-container">
    <view class="head-wrap">
      ...
      <view class="search-box">
        <view class="search-content">
          ...
          <input type="text" placeholder-class="placeholder" placeholder="根据商品名称/商品规格值搜索" v-model="searchValue"
    ...
    <view class="add-card">
      <view class="add-card-title">
        共 {{ productList.length }} 件，已选中 {{ selectedCount }} 件
      </view>
    ...
    <BaseBottomBtn text="确定" @click="handleSubmit" />
  </BaseContainer>
</template>
