  ...
  <view class="content" v-if="!isWxWorkEnv || (isWxWorkEnv && data.id)">
        ...
        <view class="details-content plr10">
          <view class="company-header mb12">
            <view class="company-name">
              ...
              <view class="name-content">
                ...
                <text
                  ...
                  >{{ data.clientInfo.work_customer.type == 1 ? '@微信' : '@' + data.clientInfo.work_customer.corp_name || '--' }}</text
                >
            ...
            <view
              ...
              >{{ data.clientInfo.customer_status.name || '--' }}
            </view>
          ...
          <view class="info-content display-align mb12">
            <view class="info-user">业务员：{{ data.clientInfo.salesman || '--' }} </view>
          ...
          <view v-if="data.member && data.member.length > 0" class="info-content display-align mb12">
            <view class="info-collaborator">协作者：</view>
        ...
        <view class="m15" style="padding-bottom: 0">
          ...
          <view class="genjinBox">
            ...
            <view class="btn-box">
              ...
              <view class="btn" @click="handleConfirm">提交</view>
            </view>
          </view>
      ...
      <view v-if="data.currentId === 3">
        <view class="add-record-title payment">
          ...
          <view v-if="data.census" class="record-account">
            <view
              >收款金额(元)：<text style="font-size: 24rpx; font-weight: 500">{{ data.census.income }}</text></view
            >
            <view
              >支出金额(元)：<text style="color: #ff4949; font-size: 24rpx; font-weight: 500">{{ data.census.expend }}</text>
            </view>
          </view>
        </view>
    ...
    <uni-popup ref="popupRef" background-color="#fff" type="bottom" v-if="data.currentPickerData.length">
      <view class="uni-picker-header">
        <view class="uni-picker-action uni-picker-action-cancel" @click="cancelPopup()">取消</view>
        <view class="uni-picker-action uni-picker-action-confirm" @click="confirmPopup(data.currentType)">完成 </view>
      </view>
