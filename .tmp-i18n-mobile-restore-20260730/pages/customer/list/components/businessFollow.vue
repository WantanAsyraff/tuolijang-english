  ...
  <view v-if="businessData.length>0" class="customer-tab-info">
    ...
    <view class="info-item" v-for="(item,index) in businessData" :key="index">
      ...
      <uni-row style="margin-bottom: 12px;">
        <uni-col :span="5" class="text-right info-item-left">商机编号</uni-col>
        <uni-col :span="19" class="info-item-right">
			...
			<uni-row style="margin-bottom: 12px;">
			 <uni-col :span="5" class="text-right info-item-left">商机报价</uni-col>
			 <uni-col :span="19" class="info-item-right">
				<text>{{item.total_amount}}</text>
			 </uni-col>
			</uni-row>
			<uni-row style="margin-bottom: 12px;">
			 <uni-col :span="5" class="text-right info-item-left">业务员</uni-col>
			 <uni-col :span="19" class="info-item-right">
				<text>{{item.salesman.name}}</text>
			 </uni-col>
			</uni-row>
			<uni-row style="margin-bottom: 12px;">
			 <uni-col :span="5" class="text-right info-item-left">跟进时间</uni-col>
			 <uni-col :span="19" class="info-item-right">
			...
			<uni-row class="bgf">
				<view  class="genjinBox">
					<uni-easyinput :inputBorder="false" v-model="item.content" type="textarea" :clearable="false"
					  :maxlength="256" placeholder="请填写商机跟进" class="mb10">
					</uni-easyinput>
					<!-- 文件 -->
					<view class="btn-box">
					  <view class="addfujian" @click="uploadAvatar(item)"> <text class="iconfont icon-fujian"></text>
					    添加附件</view>
					  <view class="btn" @click="handleConfirm(item)">提交</view>
					</view>
				</view>
				<view>
