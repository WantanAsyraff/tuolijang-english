          ...
          <view class="content-list" v-if="contentList.length > 0">
            ...
            >
              ...
              <view v-if="item.types === 'text'" class="flex">
                ...
                <view class="text-box">
                  <text @click.stop="openReply(item)" class="action-btn">选择</text>

                  <text @click.stop="handleEdit(item)" class="action-btn">编辑</text>

                  <text @click.stop="handleDelete(item)" class="action-btn delete-btn">删除</text>
                </view>
              </view>
              ...
              <view v-else-if="item.types === 'mini_program'">
                ...
                <view class="tips"> <text class="iconfont icon-xiaochengxu"></text>小程序</view>
              </view>
            </view>
          </view>
          <!-- 缺省页 -->
