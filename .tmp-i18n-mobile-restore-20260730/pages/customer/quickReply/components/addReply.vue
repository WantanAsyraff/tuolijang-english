  ...
  <uni-popup ref="popupRef" type="bottom" @change="popupChange">
    <view class="popup-wrapper">
      <view class="popup-header">
        <text class="title">{{ isEdit ? '编辑快捷回复' : '新建快捷回复' }}</text>
      </view>

      <view class="popup-content">
        <view class="form-item">
          <view class="form-label required">回复内容</view>
        ...
        <view class="form-item">
          <view class="form-label">排序 <text @click="handleSort" class="iconfont icon-yemiantishi"></text></view>
      ...
      <view class="popup-footer">
        <view class="btn btn-cancel" @click="popupClose">取消</view>
