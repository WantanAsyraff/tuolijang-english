          ...
          <view class="item-list" @click="itemList(item)">
            <view class="item-list-content">
             ...
             <uni-row class="item-content">
                <uni-col :span="5" class="left">付款金额</uni-col>
                <uni-col :span="19" class="jine">{{ item.amount || '--' }}元</uni-col>
              </uni-row>
             <uni-row class="item-content">
                <uni-col :span="5" class="left">发票抬头</uni-col>
                <uni-col :span="19" >{{ item.title || '--' }}</uni-col>
              </uni-row>
             <uni-row class="item-content">
                <uni-col :span="5" class="left">申请人</uni-col>
                <uni-col :span="19" >{{ item.card?item.card.name: '--' }}</uni-col>
              </uni-row>
             <uni-row class="item-content">
                <uni-col :span="5" class="left">开票日期</uni-col>
