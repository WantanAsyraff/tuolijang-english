          ...
          <view class="item-list">
            <view @click="examineList(item)" >
              ...
              <uni-row class="item-list-content">
                <uni-col :span="5" class="left">联系电话</uni-col>
                <uni-col :span="19">{{ item.phone || '--' }}</uni-col>
              </uni-row>
              <uni-row class="item-list-content">
                <uni-col :span="5" class="left">线索来源</uni-col>
                <uni-col :span="19">{{ item.source.name || '--' }}</uni-col>
              </uni-row>
              <uni-row class="item-list-content">
              ...
              <uni-row class="item-list-content">
                <uni-col :span="5" class="left">添加时间</uni-col>
                <uni-col :span="19">
