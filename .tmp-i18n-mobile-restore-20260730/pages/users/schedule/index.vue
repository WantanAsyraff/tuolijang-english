    ...
    <view class="cr-position-header calendar-header">
      ...
      <view class="flex-header">
        <view class="view-tabs">
          <view class="tab-item" :class="{ active: data.viewType === 'calendar' }" @click="data.viewType = 'calendar'">日程</view>
          <view class="tab-item" :class="{ active: data.viewType === 'todo' }" @click="switchToTodo">待办</view>
        </view>
