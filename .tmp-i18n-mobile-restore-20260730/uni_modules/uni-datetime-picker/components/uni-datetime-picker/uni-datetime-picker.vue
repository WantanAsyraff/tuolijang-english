<template>
	<view class="uni-date">
		...
		<Calendar v-if="isPhone" ref="mobile" :clearDate="false" :date="calendarDate" :defTime="mobileCalendarTime"
			...
			:hideSecond="hideSecond" @confirm="mobileChange" @maskClose="close" @change="calendarClick" @clear="() => clear(false)" :clear-btn="!!(hasSlotClear && showClearIcon)" />
	</view>
</template>
<script>
	/**
