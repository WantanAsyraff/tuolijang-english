        ...
        <table class="layui-table">
            ...
            @foreach($data['list'] as $item)
                <tr>
                    ...
                    <td>{{$item['uid']}}</td>
                    <td>
                        <button type="button" class="layui-btn layui-btn-sm" onclick="view('{{$item['file_id']}}')">{{ __('frontend.documents.view') }}</button>
                        <button type="button" class="layui-btn layui-btn-sm" onclick="edit('{{$item['file_id']}}')">{{ __('frontend.documents.edit') }}</button>
                    </td>
                </tr>
            @endforeach
            </thead>
